...
public class MakeItemHead {
 
    private ItemStack ik;
 
    public MakeItemHead(Material material) {
        ik = new ItemStack(material);
    }
 
    public MakeItemHead(Material material, byte data) {
        ik = new ItemStack(material, 1, data);
    }
 
    public MakeItemHead(String owner) {
    ...
    public MakeItemHead(String owner, String name) {
        ik = new ItemStack(Material.SKULL_ITEM, 1, (byte) 3);
        SkullMeta skullMeta = (SkullMeta) ik.getItemMeta();
    ...
    public MakeItemHead addEnchantment(Enchantment enchant, int level) {
    ...
    public MakeItemHead(int material, byte data) {
        ik = new ItemStack(material, 1, data);
    }
 
    public MakeItemHead(ItemStack ik) {
        this.ik = ik.clone();
    }
 
    @SuppressWarnings("deprecation")
    public MakeItemHead(int material) {
        ik = new ItemStack(material);
    }
 
    public MakeItemHead setAmout(int amount) {
        ik.setAmount(amount);
        return this;
    }
 
    public MakeItemHead setName(String name) {
    ...
    public MakeItemHead setColor(Color color) {
    ...
    public MakeItemHead setLore(ArrayList<String> lore) {
        ItemMeta im = ik.getItemMeta();
    ...
    public MakeItemHead addLore(ArrayList<String> lore, ChatColor color) {
        ItemMeta im = ik.getItemMeta();
        ArrayList<String> lorer = new ArrayList<>();
        for (String r : lore) {
    ...
    public MakeItemHead addLoreList(String... name) {
        for (String s : name) {
            addLore(s);
        }
        return this;
    ...
    public MakeItemHead addLore(ArrayList<String> lore) {
        ItemMeta im = ik.getItemMeta();
        ArrayList<String> lorer = new ArrayList<>();
        for (String r : lore) {
            lorer.add(r.replace("&", "�"));
    ...
    public MakeItemHead addLore(String lore) {
        ItemMeta im = ik.getItemMeta();
    ...
    public MakeItemHead remLore(int amount) {
        ItemMeta im = ik.getItemMeta();
        List<String> lorer = new ArrayList<>();
        if (im.hasLore()) {
            lorer = im.getLore();
    ...
    public MakeItemHead setMaxStackSize(int amount) {
    ...
    public MakeItemHead setLore(List<String> lore) {
